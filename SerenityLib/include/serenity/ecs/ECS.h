...
#include <serenity/ecs/ECSSystem.h>
...
namespace Engine::priv {
    class ECS final {
        ...
        public:
            ...
            template<class COMPONENT> [[nodiscard]] inline constexpr ECSComponentPool<COMPONENT>& getPool() const {
                using CPOOL = ECSComponentPool<COMPONENT>;
                auto type_slot  = m_Registry.type_slot_fast<COMPONENT>();
                return *(CPOOL*)m_ComponentPools[type_slot];
            }

            template<class COMPONENT> [[nodiscard]] inline constexpr ECSSystem<COMPONENT>& getSystem() const {
                auto type_slot = m_Registry.type_slot_fast<COMPONENT>();
            ...
            template<class T> [[nodiscard]] inline constexpr Engine::view_ptr<T> getComponent(Entity entity) const noexcept {
