...
namespace Engine::priv {
    class ShaderHelper final {
        public:
            [[nodiscard]] static inline bool sfind(std::string_view whole, std::string_view part) noexcept {
                return whole.find(part) != std::string::npos;
            }
            [[nodiscard]] static inline bool lacksDefinition(std::string_view inSrc, std::string_view searchedCode, std::string_view definition) {
