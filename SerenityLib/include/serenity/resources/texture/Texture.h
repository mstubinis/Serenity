...
class Texture: public Resource {
    ...
    public:
        ...
        [[nodiscard]] GLuint address() const noexcept { return m_TextureAddress; }
        [[nodiscard]] inline constexpr TextureType getTextureType() const noexcept { return m_CPUData.m_TextureType; }
