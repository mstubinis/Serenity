...
#include <serenity/core/engine/networking/ISocket.h>
...
namespace Engine::Networking {
    class ServerClient : public Observer {
        ...
        public:
            ...
            inline Engine::Networking::SocketTCP* socket() const noexcept { return m_TcpSocket.get(); }
            inline constexpr uint16_t port() const noexcept { return m_Port; }
            inline sf::IpAddress ip() const noexcept { return m_IP; }
