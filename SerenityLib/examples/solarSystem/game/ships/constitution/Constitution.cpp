...
Constitution::Constitution(Client& client, bool player, const string& name, glm::vec3 position, glm::vec3 scale, CollisionType::Type collisionType, Map* map)
:Ship(client, ResourceManifest::ConstitutionMesh, ResourceManifest::ConstitutionMaterial, "Constitution", player, name, position, scale, collisionType, map) {
