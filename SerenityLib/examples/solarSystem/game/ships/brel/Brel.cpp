...
:Ship(client, ResourceManifest::BrelMesh, ResourceManifest::BrelMaterial, "Brel", map,player, name, position, scale, collisionType, glm::vec3(0.0f, 0.311455f, 0.397761f), glm::vec3(0.0f,0.7f,0.7f)) {
    ...
    //blender 3d to game 3d: switch y and z, then negate z
    auto* leftTop = new DisruptorCannon(_this, map, glm::vec3(-1.01261f, -0.315514f, -0.550506f), glm::vec3(0.01f, 0, -1), 10.0f, 6, 250, 0.7f, 2.5f, 1.8f, 50.5f, 25.0f);
    auto* leftBottom = new DisruptorCannon(_this, map, glm::vec3(-1.01515f, -0.338814f, -0.544875f), glm::vec3(0.01f, 0, -1), 10.0f, 6, 250, 0.7f, 2.5f, 1.8f, 50.5f, 25.0f);
    auto* rightBottom = new DisruptorCannon(_this, map, glm::vec3(1.01515f, -0.338814f, -0.544875f), glm::vec3(-0.01f, 0, -1), 10.0f, 6, 250, 0.7f, 2.5f, 1.8f, 50.5f, 25.0f);
    auto* rightTop = new DisruptorCannon(_this, map, glm::vec3(1.01261f, -0.315514f, -0.550506f), glm::vec3(-0.01f, 0, -1), 10.0f, 6, 250, 0.7f, 2.5f, 1.8f, 50.5f, 25.0f);
