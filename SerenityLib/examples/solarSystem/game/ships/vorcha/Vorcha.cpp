...
Vorcha::Vorcha(Client& client, Map& map, bool player, const string& name, glm::vec3 position, glm::vec3 scale, CollisionType::Type collisionType)
:Ship(client, "Vor'cha", map, player, name, position, scale, collisionType, glm::vec3(0.0f, 0.0f, -1.58693f)) {
