...
PhotonTorpedoProjectile::PhotonTorpedoProjectile(PhotonTorpedo& source, Map& map, const glm_vec3& position, const glm_vec3& forward, const int index, const glm_vec3& chosen_target_pos):torpedo(source), SecondaryWeaponTorpedoProjectile(map,position,forward,index){
    maxTime = 30.5f;
