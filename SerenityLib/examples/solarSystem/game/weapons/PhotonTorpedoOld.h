...
struct PhotonTorpedoOldProjectile final : public SecondaryWeaponTorpedoProjectile {
    ...
    PhotonTorpedoOldProjectile(EntityWrapper* target, PhotonTorpedoOld&, Map& map, const glm_vec3& final_world_position, const glm_vec3& forward, const int index, const glm_vec3& chosen_target_pos);
...
class PhotonTorpedoOld final : public SecondaryWeaponTorpedo {
    ...
    public:
        PhotonTorpedoOld(
            ...
            const float& damage = 6250.0f,
            const float& _rechargePerRound = 14.5f,
