...
struct KlingonPhotonTorpedoProjectile final : public SecondaryWeaponTorpedoProjectile {
    ...
    KlingonPhotonTorpedoProjectile(EntityWrapper* target, KlingonPhotonTorpedo&, Map& map, const glm_vec3& final_world_position, const glm_vec3& forward, const int index, const glm_vec3& chosen_target_pos);
