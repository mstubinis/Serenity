...
void Engine::priv::ECSEntityPool::destroyFlaggedEntity(std::uint32_t entityID) {
...
Entity Engine::priv::ECSEntityPool::getEntity(std::uint32_t entityData) const noexcept {
    if (entityData == 0) {
        return Entity{};
    }
