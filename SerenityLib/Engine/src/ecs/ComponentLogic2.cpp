...
struct priv::ComponentLogic2_UpdateFunction final {void operator()(void* componentPool, const float& dt, Scene& scene) const {
...
struct priv::ComponentLogic2_ComponentAddedToEntityFunction final {void operator()(void* component, Entity& entity) const {

}};
struct priv::ComponentLogic2_EntityAddedToSceneFunction final {void operator()(void* componentPool, Entity& entity, Scene& scene) const {
}};
struct priv::ComponentLogic2_SceneEnteredFunction final {void operator()(void* componentPool, Scene& scene) const {

}};
struct priv::ComponentLogic2_SceneLeftFunction final {void operator()(void* componentPool, Scene& scene) const {
