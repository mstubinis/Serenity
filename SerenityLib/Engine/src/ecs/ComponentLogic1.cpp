...
struct priv::ComponentLogic1_UpdateFunction final {void operator()(void* componentPool, const float& dt, Scene& scene) const {
...
struct priv::ComponentLogic1_ComponentAddedToEntityFunction final {void operator()(void* component, Entity& entity) const {

}};
struct priv::ComponentLogic1_EntityAddedToSceneFunction final {void operator()(void* componentPool, Entity& entity, Scene& scene) const {
}};
struct priv::ComponentLogic1_SceneEnteredFunction final {void operator()(void* componentPool, Scene& scene) const {

}};
struct priv::ComponentLogic1_SceneLeftFunction final {void operator()(void* componentPool, Scene& scene) const {
