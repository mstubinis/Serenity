...
void priv::EventDispatcher::registerObject(EventObserver* observerToRegister, const EventType::Type& eventType){
...
void priv::EventDispatcher::unregisterObject(EventObserver* obj, const EventType::Type& eventType){
