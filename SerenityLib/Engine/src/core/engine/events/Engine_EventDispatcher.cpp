...
bool priv::EventDispatcher::isObjectRegistered(const EventObserver& observer, const EventType::Type eventType) const {
...
bool priv::EventDispatcher::isObjectRegistered(const EventObserver& observer, const unsigned int eventType) const {
