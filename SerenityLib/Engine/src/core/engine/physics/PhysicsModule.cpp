...
void Engine::priv::PhysicsModule::_init(){
...
void Engine::priv::PhysicsModule::_update(const float dt, int maxSubSteps, float fixedTimeStep){
    if (m_Paused) {
        return;
    }
...
void Engine::priv::PhysicsModule::_render(const Camera& camera){
