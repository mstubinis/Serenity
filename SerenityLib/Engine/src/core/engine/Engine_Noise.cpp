...
class epriv::NoiseManager::impl final{
    public:
        ...
        vector<short> m_Perm;
        vector<short> m_PermGradIndex3D;
        ...
        double _noiseOpenSimplex2D(double& x, double& y){
            ...
            if (attn1 > 0) {
                attn1 *= attn1;
                value += attn1 * attn1 * _extrapolate(xsb + 1, ysb + 0, dx1, dy1);
            }
            ...
            if (attn2 > 0) {
                attn2 *= attn2;
                value += attn2 * attn2 * _extrapolate(xsb + 0, ysb + 1, dx2, dy2);
            }    
            if (inSum <= 1) {
                double zins = 1 - inSum;
            ...
            if (attn0 > 0) {
                attn0 *= attn0;
                value += attn0 * attn0 * _extrapolate(xsb, ysb, dx0, dy0);
            }
            double attn_ext = 2 - dx_ext * dx_ext - dy_ext * dy_ext;
            if (attn_ext > 0) {
                attn_ext *= attn_ext;
                value += attn_ext * attn_ext * _extrapolate(xsv_ext, ysv_ext, dx_ext, dy_ext);
            }    
        ...
        double _noiseOpenSimplex3D(double& x, double& y, double& z){
            ...
            if (inSum <= 1) {
                ...
                if (attn0 > 0) {
                    attn0 *= attn0;
                    value += attn0 * attn0 * _extrapolate(xsb + 0, ysb + 0, zsb + 0, dx0, dy0, dz0);
                }
                ...
                if (attn1 > 0) {
                    attn1 *= attn1;
                    value += attn1 * attn1 * _extrapolate(xsb + 1, ysb + 0, zsb + 0, dx1, dy1, dz1);
                }
                ...
                if (attn2 > 0) {
                    attn2 *= attn2;
                    value += attn2 * attn2 * _extrapolate(xsb + 0, ysb + 1, zsb + 0, dx2, dy2, dz2);
                }
                double dx3 = dx2;
                double dy3 = dy1;
                ...
                if (attn3 > 0) {
                    attn3 *= attn3;
                    value += attn3 * attn3 * _extrapolate(xsb + 0, ysb + 0, zsb + 1, dx3, dy3, dz3);
                }
            } else if (inSum >= 2) {
                int8_t aPoint = 0x06;
                double aScore = xins;
                ...
                if (attn3 > 0) {
                    attn3 *= attn3;
                    value += attn3 * attn3 * _extrapolate(xsb + 1, ysb + 1, zsb + 0, dx3, dy3, dz3);
                }
                double dx2 = dx3;
                ...
                if (attn2 > 0) {
                    attn2 *= attn2;
                    value += attn2 * attn2 * _extrapolate(xsb + 1, ysb + 0, zsb + 1, dx2, dy2, dz2);
                }
                ...
                if (attn1 > 0) {
                    attn1 *= attn1;
                    value += attn1 * attn1 * _extrapolate(xsb + 0, ysb + 1, zsb + 1, dx1, dy1, dz1);
                }
                ...
                if (attn0 > 0) {
                    attn0 *= attn0;
                    value += attn0 * attn0 * _extrapolate(xsb + 1, ysb + 1, zsb + 1, dx0, dy0, dz0);
                }
            } else {
                double aScore;
                int8_t aPoint;
                ...
                if (attn4 > 0) {
                    attn4 *= attn4;
                    value += attn4 * attn4 * _extrapolate(xsb + 1, ysb + 1, zsb + 0, dx4, dy4, dz4);
                }
                double dx5 = dx4;
                ...
                if (attn5 > 0) {
                    attn5 *= attn5;
                    value += attn5 * attn5 * _extrapolate(xsb + 1, ysb + 0, zsb + 1, dx5, dy5, dz5);
                }
                ...
                if (attn6 > 0) {
                    attn6 *= attn6;
                    value += attn6 * attn6 * _extrapolate(xsb + 0, ysb + 1, zsb + 1, dx6, dy6, dz6);
                }
            }
            double attn_ext0 = 2 - dx_ext0 * dx_ext0 - dy_ext0 * dy_ext0 - dz_ext0 * dz_ext0;
            if (attn_ext0 > 0){
                attn_ext0 *= attn_ext0;
                value += attn_ext0 * attn_ext0 * _extrapolate(xsv_ext0, ysv_ext0, zsv_ext0, dx_ext0, dy_ext0, dz_ext0);
            }
            double attn_ext1 = 2 - dx_ext1 * dx_ext1 - dy_ext1 * dy_ext1 - dz_ext1 * dz_ext1;
            if (attn_ext1 > 0){
                attn_ext1 *= attn_ext1;
                value += attn_ext1 * attn_ext1 * _extrapolate(xsv_ext1, ysv_ext1, zsv_ext1, dx_ext1, dy_ext1, dz_ext1);
            }   
        ...
        double _noiseOpenSimplex4D(double& x, double& y, double& z, double& w){
            ...
            if (inSum <= 1) {
                ...
                if (attn0 > 0) {
                    attn0 *= attn0;
                    value += attn0 * attn0 * _extrapolate(xsb + 0, ysb + 0, zsb + 0, wsb + 0, dx0, dy0, dz0, dw0);
                }
                ...
                if (attn1 > 0) {
                    attn1 *= attn1;
                    value += attn1 * attn1 * _extrapolate(xsb + 1, ysb + 0, zsb + 0, wsb + 0, dx1, dy1, dz1, dw1);
                }
                ...
                if (attn2 > 0) {
                    attn2 *= attn2;
                    value += attn2 * attn2 * _extrapolate(xsb + 0, ysb + 1, zsb + 0, wsb + 0, dx2, dy2, dz2, dw2);
                }
                double dx3 = dx2;
                double dy3 = dy1;
                ...
                if (attn3 > 0) {
                    attn3 *= attn3;
                    value += attn3 * attn3 * _extrapolate(xsb + 0, ysb + 0, zsb + 1, wsb + 0, dx3, dy3, dz3, dw3);
                }
                double dx4 = dx2;
                double dy4 = dy1;
                double dz4 = dz1;
                ...
                if (attn4 > 0) {
                    attn4 *= attn4;
                    value += attn4 * attn4 * _extrapolate(xsb + 0, ysb + 0, zsb + 0, wsb + 1, dx4, dy4, dz4, dw4);
                }
            } else if (inSum >= 3) {
                int8_t aPoint = 0x0E;
                double aScore = xins;
                ...
                if (attn4 > 0) {
                    attn4 *= attn4;
                    value += attn4 * attn4 * _extrapolate(xsb + 1, ysb + 1, zsb + 1, wsb + 0, dx4, dy4, dz4, dw4);
                }
                double dx3 = dx4;
                double dy3 = dy4;
                ...
                if (attn3 > 0) {
                    attn3 *= attn3;
                    value += attn3 * attn3 * _extrapolate(xsb + 1, ysb + 1, zsb + 0, wsb + 1, dx3, dy3, dz3, dw3);
                }
                double dx2 = dx4;
                ...
                if (attn2 > 0) {
                    attn2 *= attn2;
                    value += attn2 * attn2 * _extrapolate(xsb + 1, ysb + 0, zsb + 1, wsb + 1, dx2, dy2, dz2, dw2);
                }
                ...
                if (attn1 > 0) {
                    attn1 *= attn1;
                    value += attn1 * attn1 * _extrapolate(xsb + 0, ysb + 1, zsb + 1, wsb + 1, dx1, dy1, dz1, dw1);
                }
                ...
                if (attn0 > 0) {
                    attn0 *= attn0;
                    value += attn0 * attn0 * _extrapolate(xsb + 1, ysb + 1, zsb + 1, wsb + 1, dx0, dy0, dz0, dw0);
                }
            } else if (inSum <= 2) {
                double aScore;
                int8_t aPoint;
                ...
                if (attn5 > 0) {
                    attn5 *= attn5;
                    value += attn5 * attn5 * _extrapolate(xsb + 1, ysb + 1, zsb + 0, wsb + 0, dx5, dy5, dz5, dw5);
                }
                ...
                if (attn6 > 0) {
                    attn6 *= attn6;
                    value += attn6 * attn6 * _extrapolate(xsb + 1, ysb + 0, zsb + 1, wsb + 0, dx6, dy6, dz6, dw6);
                }
                ...
                if (attn7 > 0) {
                    attn7 *= attn7;
                    value += attn7 * attn7 * _extrapolate(xsb + 1, ysb + 0, zsb + 0, wsb + 1, dx7, dy7, dz7, dw7);
                }
                ...
                if (attn8 > 0) {
                    attn8 *= attn8;
                    value += attn8 * attn8 * _extrapolate(xsb + 0, ysb + 1, zsb + 1, wsb + 0, dx8, dy8, dz8, dw8);
                }
                ...
                if (attn9 > 0) {
                    attn9 *= attn9;
                    value += attn9 * attn9 * _extrapolate(xsb + 0, ysb + 1, zsb + 0, wsb + 1, dx9, dy9, dz9, dw9);
                }
                ...
                if (attn10 > 0) {
                    attn10 *= attn10;
                    value += attn10 * attn10 * _extrapolate(xsb + 0, ysb + 0, zsb + 1, wsb + 1, dx10, dy10, dz10, dw10);
                }
            } else {
                double aScore;
                int8_t aPoint;
            ...
            if (attn_ext0 > 0){
                attn_ext0 *= attn_ext0;
                value += attn_ext0 * attn_ext0 * _extrapolate(xsv_ext0, ysv_ext0, zsv_ext0, wsv_ext0, dx_ext0, dy_ext0, dz_ext0, dw_ext0);
            }
            double attn_ext1 = 2 - dx_ext1 * dx_ext1 - dy_ext1 * dy_ext1 - dz_ext1 * dz_ext1 - dw_ext1 * dw_ext1;
            if (attn_ext1 > 0){
                attn_ext1 *= attn_ext1;
                value += attn_ext1 * attn_ext1 * _extrapolate(xsv_ext1, ysv_ext1, zsv_ext1, wsv_ext1, dx_ext1, dy_ext1, dz_ext1, dw_ext1);
            }
            double attn_ext2 = 2 - dx_ext2 * dx_ext2 - dy_ext2 * dy_ext2 - dz_ext2 * dz_ext2 - dw_ext2 * dw_ext2;
            if (attn_ext2 > 0){
                attn_ext2 *= attn_ext2;
                value += attn_ext2 * attn_ext2 * _extrapolate(xsv_ext2, ysv_ext2, zsv_ext2, wsv_ext2, dx_ext2, dy_ext2, dz_ext2, dw_ext2);
            }
...
epriv::NoiseManager::NoiseManager(const char* name,uint w,uint h):m_i(new impl){ m_i->_init(name,w,h); noiseManager = m_i.get(); }
epriv::NoiseManager::~NoiseManager(){ m_i->_destruct(); }
double Noise::noiseOpenSimplex2D(double x, double y){ return noiseManager->_noiseOpenSimplex2D(x,y); }
double Noise::noiseOpenSimplex3D(double x, double y, double z){ return noiseManager->_noiseOpenSimplex3D(x,y,z); }
double Noise::noiseOpenSimplex4D(double x, double y, double z, double w){ return noiseManager->_noiseOpenSimplex4D(x,y,z,w); }
double Noise::noiseOpenSimplex2D(double x, double y,unsigned long long seed){ return noiseManager->_noiseOpenSimplex2D(x,y,seed); }
double Noise::noiseOpenSimplex3D(double x, double y, double z,unsigned long long seed){ return noiseManager->_noiseOpenSimplex3D(x,y,z,seed); }
double Noise::noiseOpenSimplex4D(double x, double y, double z, double w,unsigned long long seed){ return noiseManager->_noiseOpenSimplex4D(x,y,z,w,seed); }