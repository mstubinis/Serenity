...
namespace Engine::priv {
    struct TextureLoader final {
        ...
        static unsigned int OpenglTypeFromTextureType(TextureType type) noexcept;
        ...
        static void InitFramebuffer(Texture&, int w, int h, ImagePixelType pxlType, ImagePixelFormat pxlFormat, ImageInternalFormat _internal, float divisor);
