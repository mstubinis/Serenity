...
namespace Engine::Networking {
    class Server : public Observer, public Engine::NonCopyable, public Engine::NonMoveable {
        ...
        private:
            ...
            void internal_send_to_all_tcp(ServerClient* exclusion, Packet& packet);
            ...
            void internal_send_to_all_udp(ServerClient* exclusion, Packet& packet);
        ...
        public:
            ...
            //tcp
            SocketStatus::Status send_tcp_to_client(ServerClient& client, Packet& packet);
            SocketStatus::Status send_tcp_to_client(ServerClient& client, sf::Packet& packet);
            void send_tcp_to_all_but_client(ServerClient& exclusion, Packet& packet);
            void send_tcp_to_all_but_client(ServerClient& exclusion, sf::Packet& packet);
            void send_tcp_to_all(Packet& packet);
            ...
            //udp
            SocketStatus::Status send_udp_to_client(ServerClient& client, Packet& packet);
            SocketStatus::Status send_udp_to_client(ServerClient& client, sf::Packet& packet);
            void send_udp_to_all_but_client(ServerClient& exclusion, Packet& packet);
            void send_udp_to_all_but_client(ServerClient& exclusion, sf::Packet& packet);
            void send_udp_to_all(Packet& packet);
