...
class epriv::NoiseManager::impl final{
    public:
        ...
        void _initFromSeed(const unsigned long long& seed){
        ...
        double _noiseOpenSimplex2D(const double& x, const double& y){
        ...
        double _noiseOpenSimplex2D(const double& x, const double& y, const unsigned long long& seed){
            _initFromSeed(seed);
            return _noiseOpenSimplex2D(x,y);
        }
        double _noiseOpenSimplex3D(const double& x, const double& y, const double& z){
        ...
        double _noiseOpenSimplex3D(const double& x, const double& y, const double& z, const unsigned long long& seed){
            _initFromSeed(seed);
            return _noiseOpenSimplex3D(x,y,z);
        }
        double _noiseOpenSimplex4D(const double& x, const double& y, const double& z, const double& w){
        ...
        double _noiseOpenSimplex4D(const double& x, const double& y, const double& z, const double& w, const unsigned long long& seed){
            _initFromSeed(seed);
            return _noiseOpenSimplex4D(x,y,z,w);
        }
};
epriv::NoiseManager::impl* noiseManager;
epriv::NoiseManager::NoiseManager(const char* name, const uint& w, const uint& h):m_i(new impl){ m_i->_init(name,w,h); noiseManager = m_i.get(); }
