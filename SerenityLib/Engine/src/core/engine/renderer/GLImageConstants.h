...
class ImageInternalFormat final {
    public: enum Type {
        Unknown = 0,
    ...
    private:
        ImageInternalFormat::Type m_Type = ImageInternalFormat::Unknown;
    public:
        constexpr ImageInternalFormat() = default;
        constexpr ImageInternalFormat(const ImageInternalFormat::Type other) { m_Type = other; }
        inline constexpr bool operator==(const ImageInternalFormat::Type other) const noexcept { return m_Type == other; }
        inline constexpr bool operator!=(const ImageInternalFormat::Type other) const noexcept { return !operator==(other); }
        inline constexpr void operator=(const ImageInternalFormat::Type other) noexcept { m_Type = other; }
        inline constexpr explicit operator ImageInternalFormat::Type() const noexcept { return m_Type; }
        inline constexpr explicit operator GLuint() const noexcept { return m_Type; }
        inline constexpr explicit operator GLint() const noexcept { return m_Type; }
        constexpr bool isCompressedType() const noexcept {
            switch (m_Type) {
        ...
        explicit operator ImagePixelFormat() const noexcept;
};
/*
...
class ImagePixelFormat final {
    ...
    private:
        ImagePixelFormat::Type m_Type = ImagePixelFormat::Unknown;
    public:
        constexpr ImagePixelFormat() = default;
        constexpr ImagePixelFormat(const ImagePixelFormat::Type other)
            : m_Type{ other }
        {}
        ImagePixelFormat(const ImageInternalFormat other)
            : m_Type { static_cast<ImagePixelFormat::Type>(other.operator ImagePixelFormat().m_Type) }
        {}
        ImagePixelFormat& operator=(const ImagePixelFormat::Type other) {
            m_Type = other;
            return *this;
        }
        ImagePixelFormat& operator=(const ImageInternalFormat other) {
            m_Type = static_cast<ImagePixelFormat::Type>(other.operator ImagePixelFormat().m_Type);
            return *this;
        }
        inline constexpr bool operator==(const ImagePixelFormat::Type other) const noexcept { return m_Type == other; }
        inline constexpr bool operator!=(const ImagePixelFormat::Type other) const noexcept { return !operator==(other); }
        inline explicit constexpr operator GLuint() const noexcept { return static_cast<GLuint>(m_Type); }
};
