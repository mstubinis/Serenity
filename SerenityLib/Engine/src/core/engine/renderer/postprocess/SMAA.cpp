...
void SMAA::passEdge(ShaderProgram& program, GBuffer& gbuffer, const glm::vec4& PIXEL_SIZE, const unsigned int& fboWidth, const unsigned int& fboHeight, const unsigned int& sceneTexture, const unsigned int& outTexture) {
    gbuffer.bindFramebuffers(outTexture); //probably the lighting buffer
    program.bind();

    Renderer::Settings::clear(true, false, true);//lighting rgba, stencil is completely filled with 0's
...
void SMAA::passBlend(ShaderProgram& program, GBuffer& gbuffer, const glm::vec4& PIXEL_SIZE, const unsigned int& fboWidth, const unsigned int& fboHeight, const unsigned int& outTexture) {
...
void SMAA::passNeighbor(ShaderProgram& program, GBuffer& gbuffer, const glm::vec4& PIXEL_SIZE, const unsigned int& fboWidth, const unsigned int& fboHeight, const unsigned int& sceneTexture) {
    program.bind();
    Renderer::sendUniform4("SMAA_PIXEL_SIZE", PIXEL_SIZE);
...
void SMAA::passFinal(ShaderProgram& program, GBuffer& gbuffer, const unsigned int& fboWidth, const unsigned int& fboHeight) {
    /*
