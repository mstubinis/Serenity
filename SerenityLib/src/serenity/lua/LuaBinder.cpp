...
#pragma endregion
        ...
        .beginClass<Camera>("Camera")
            ...
            .addFunction("getAspectRatio", &Camera::getAspect)
            .addFunction("setAspectRatio", &Camera::setAspect)
        ...
        .beginClass<ComponentTransform>("ComponentTransform")
            ...
            .addFunction("alignTo", static_cast<void(ComponentTransform::*)(const glm_vec3&)>(&ComponentTransform::alignTo))
            .addFunction("alignTo", static_cast<void(ComponentTransform::*)(decimal, decimal, decimal)>(&ComponentTransform::alignTo))
            ...
            .addFunction("forward", &ComponentTransform::forward)
            .addFunction("right", &ComponentTransform::right)
            .addFunction("up", &ComponentTransform::up)
        ...
        .beginClass<ComponentCamera>("ComponentCamera")
            .addFunction("getForward", &ComponentCamera::getForward)
