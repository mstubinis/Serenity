...
#include <serenity/core/engine/sounds/SoundQueue.h>
...
SoundEffect* Sound::playEffect(Handle handle, uint32_t loops){
...
SoundMusic* Sound::playMusic(Handle handle, uint32_t loops){
