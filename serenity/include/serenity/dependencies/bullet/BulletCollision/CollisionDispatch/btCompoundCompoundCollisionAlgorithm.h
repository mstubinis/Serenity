...
{
	class btHashedSimplePairCache* m_childCollisionAlgorithmCache = nullptr;
	btSimplePairArray m_removePairs;

	int m_compoundShapeRevision0 = 0;  //to keep track of changes, so that childAlgorithm array can be updated
	int m_compoundShapeRevision1 = 0;
