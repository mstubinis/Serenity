...
protected:
	...
	///terrain data
	int m_heightStickWidth = 0;
	int m_heightStickLength = 0;
	btScalar m_minHeight = btScalar(0.0);
	btScalar m_maxHeight = btScalar(0.0);
	btScalar m_width = btScalar(0.0);
	btScalar m_length = btScalar(0.0);
	btScalar m_heightScale = btScalar(0.0);
	union {
	...
	bool m_flipQuadEdges = false;
	bool m_useDiamondSubdivision = false;
	bool m_useZigzagSubdivision = false;
	bool m_flipTriangleWinding = false;
	int m_upAxis = 1;
	...
	int m_vboundsGridWidth = 0;
	int m_vboundsGridLength = 0;
	int m_vboundsChunkSize = 0;

	
	btScalar m_userValue3 = btScalar(0.0);

	struct btTriangleInfoMap* m_triangleInfoMap = nullptr;
	 ...
	 */
	void initialize(int heightStickWidth, int heightStickLength, const void* heightfieldData, btScalar heightScale, btScalar minHeight, btScalar maxHeight, int upAxis,
