...
inline constexpr glm::vec3 operator* (const glm::vec3& lhs, const btVector3& rhs) { 
    return lhs * glm::vec3{ rhs.x(), rhs.y(), rhs.z() }; 
}
inline btVector3 operator* (const btVector3& lhs, const glm::vec3& rhs) {
    return lhs * btVector3(rhs.x, rhs.y, rhs.z); 
}
inline constexpr glm::vec3 operator/ (const glm::vec3& lhs, const btVector3& rhs) { 
    return lhs / glm::vec3{ rhs.x(), rhs.y(), rhs.z() }; 
}
