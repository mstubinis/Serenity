...
class ComponentTransform : public ComponentBaseClass<ComponentTransform> {
    ...
    public:
        ComponentTransform(Entity, const glm_vec3& pos = glm_vec3{0.0}, const glm::quat& rot = glm::quat{ 1.0f, 0.0f, 0.0f, 0.0f }, const glm::vec3& scl = glm::vec3{ 1.0f });
        ...
        void alignTo(float dirX, float dirY, float dirZ, float radPerSec);
        void alignTo(const glm::vec3& direction, float radPerSec);
        void alignToDirection(float dirX, float dirY, float dirZ, float radPerSec);
        void alignToDirection(const glm::vec3& direction, float radPerSec);
        void alignToPosition(decimal x, decimal y, decimal z, float radPerSec);
        void alignToPosition(const glm_vec3& position, float radPerSec);
