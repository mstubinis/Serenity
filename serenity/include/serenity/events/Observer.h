...
class Observer {
    public:
        void registerEvent(EventType, Engine::priv::EventDispatcher&) noexcept;
        void unregisterEvent(EventType, Engine::priv::EventDispatcher&) noexcept;
        void unregisterEventImmediate(EventType, Engine::priv::EventDispatcher&) noexcept;
        [[nodiscard]] bool isRegistered(EventType, Engine::priv::EventDispatcher&) const noexcept;
