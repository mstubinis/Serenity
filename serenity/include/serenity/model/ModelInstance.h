...
class ModelInstance final : public Observer {
    ...
    public:
        ...
        [[nodiscard]] inline Engine::priv::ModelInstanceAnimationContainer& getRunningAnimations() noexcept { return m_Animations; }
        ...
        inline bool playAnimation(std::string_view animName, uint32_t requestedLoops, float startTime, float endTime = -1.0f, float blendTime = 0.0f) {
            return m_Animations.emplace_animation(m_MeshHandle, animName, startTime, endTime, requestedLoops, blendTime);
        }
        inline bool playAnimation(const uint16_t animIndex, uint32_t requestedLoops, float startTime, float endTime = -1.0f, float blendTime = 0.0f) {
            return m_Animations.emplace_animation(m_MeshHandle, animIndex, startTime, endTime, requestedLoops, blendTime);
        }
