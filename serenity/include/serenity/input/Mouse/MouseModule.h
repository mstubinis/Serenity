...
namespace Engine::priv {
    class MouseModule final {
        ...
        public:
            ...
            [[nodiscard]] inline bool isButtonDown(MouseButton button) const noexcept { return m_CurrMouseStatus[button]; }
            [[nodiscard]] bool isButtonDownOnce(MouseButton button) const noexcept;
    };
}
