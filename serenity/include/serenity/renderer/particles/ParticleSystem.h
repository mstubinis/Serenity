...
namespace Engine::priv {
    struct ParticleDOD final {
        ...
        ParticleMaterialIDType  MatID;
        ParticlePackedColorType PackedColor;

        ParticleDOD() = default;
        ParticleDOD(float X, float Y, float Z, float ScaleX_, float ScaleY_, float Angle_, ParticleMaterialIDType MatID_, ParticlePackedColorType PackedColor_);
...
namespace Engine::priv {
    class ParticleSystem final {
        ...
        public:
            ...
            //for the threads...
            std::vector<std::vector<Engine::priv::ParticleDOD>>        THREAD_PART_PARTICLE_DODS;
            std::vector<Engine::unordered_bimap<Material*, uint32_t>>  THREAD_PART_PARTICLE_MATERIAL_MAPPING;
        public:
            ...
            Engine::view_ptr<ParticleEmitter> add_emitter(ParticleEmissionPropertiesHandle, Scene&, float lifetime, Entity parent);
