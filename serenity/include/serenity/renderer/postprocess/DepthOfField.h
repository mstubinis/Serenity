...
namespace Engine::Renderer::depthOfField {
    ...
    inline void setFocus(float focus) noexcept { Engine::priv::DepthOfField::STATIC_DOF.focus = std::max(0.0f, focus); }
    ...
    inline void setBlurRadius(float blurRadius) noexcept { Engine::priv::DepthOfField::STATIC_DOF.blur_radius = std::max(0.0f, blurRadius); }
};
