#pragma once
#ifndef ENGINE_OPENGL_GL_IMAGE_CONSTANTS_H
#define ENGINE_OPENGL_GL_IMAGE_CONSTANTS_H
...
class ImagePixelType {
    ...
    #pragma endregion
        ...
        BUILD_ENUM_CLASS_MEMBERS(ImagePixelType, Type)
};
...
class ImageInternalFormat final {
    public: 
        ...
        BUILD_ENUM_CLASS_MEMBERS(ImageInternalFormat, Type)
    public:
        ...
        explicit operator ImagePixelFormat() const noexcept; //TODO: rethink this
};
/*
...
class ImagePixelFormat final {
    public: 
        ...
        BUILD_ENUM_CLASS_MEMBERS(ImagePixelFormat, Type)

        inline void operator=(const ImageInternalFormat& other) noexcept {
            m_Type = (other.operator ImagePixelFormat()).m_Type;
        }
};
...
class FramebufferAttatchment {
    public:
        ...
        BUILD_ENUM_CLASS_MEMBERS(FramebufferAttatchment, Type)
};
#endif
