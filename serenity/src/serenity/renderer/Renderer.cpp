...
RenderModule::RenderModule(const EngineOptions& options, uint32_t windowWidth, uint32_t windowHeight)
...
void Engine::Renderer::generateVAO(GLuint& vaoObject) {
    RENDER_MODULE->m_Pipeline->generateVAO(vaoObject);
}
