...
ImageInternalFormat::operator ImagePixelFormat() const noexcept {
    switch (m_Type) {
        case ImageInternalFormat::COMPRESSED_RED: {
            return ImagePixelFormat::Type::RED;
        }case ImageInternalFormat::COMPRESSED_RED_RGTC1: {
            return ImagePixelFormat::Type::RED; //recheck this
        }case ImageInternalFormat::COMPRESSED_RG: {
            return ImagePixelFormat::Type::RG;
        }case ImageInternalFormat::COMPRESSED_RGB: {
            return ImagePixelFormat::Type::RGB;
        }case ImageInternalFormat::COMPRESSED_RGBA: {
            return ImagePixelFormat::Type::RGBA;
            ...
            return ImagePixelFormat::Type::RG; //recheck this
            ...
            return ImagePixelFormat::Type::DEPTH_COMPONENT;
            ...
            return ImagePixelFormat::Type::DEPTH_STENCIL;
            ...
            return ImagePixelFormat::Type::RED_INTEGER;
            ...
            return ImagePixelFormat::Type::RG_INTEGER;
            ...
            return ImagePixelFormat::Type::RGB_INTEGER;
            ...
            return ImagePixelFormat::Type::RGB; //recheck this 
            ...
            return ImagePixelFormat::Type::RGBA_INTEGER;
            ...
            return ImagePixelFormat::Type::STENCIL_INDEX;
        }case ImageInternalFormat::STENCIL_INDEX: {
            return ImagePixelFormat::Type::STENCIL_INDEX;
        }
    }
    return ImagePixelFormat::Type::Unknown;
}