...
class Texture: public EngineResource{
    ...
    public:
        Texture(std::string name,uint w, uint h,ImageInternalFormat::Format,ImagePixelFormat::Format,GLuint type,GLuint attatchment,GLuint = GL_TEXTURE_2D,float divisor=1.0f);
