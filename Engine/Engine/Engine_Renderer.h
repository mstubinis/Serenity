...
namespace Engine{
	...
	//Uniform 4
        ...
        //inline void sendUniformMatrix2(const char* l,glm::imat2& m){ glUniformMatrix2iv(getUniformLocationUnsafe(l),1,0,glm::value_ptr(m)); }
        //inline void sendUniformMatrix2v(const char* l,std::vector<glm::imat2>& m,uint count){ std::vector<int> d;for(auto ma:m){int* m = glm::value_ptr(ma);for(uint i = 0; i < 4; i++){d.push_back(m[i]);}}glUniformMatrix2iv(getUniformLocationUnsafe(l),count,0,&d[0]); }
        ...
        //inline void sendUniformMatrix2i(const char* l,glm::imat2& m){ glUniformMatrix2iv(getUniformLocationUnsafe(l),1,0,glm::value_ptr(m)); }
        //inline void sendUniformMatrix2iv(const char* l,std::vector<glm::imat2>& m,uint count){ std::vector<int> d;for(auto ma:m){int* m = glm::value_ptr(ma);for(uint i = 0; i < 4; i++){d.push_back(m[i]);}}glUniformMatrix2iv(getUniformLocationUnsafe(l),count,0,&d[0]); }  
        ...
        //inline void sendUniformMatrix2iSafe(const char* l,glm::imat2& m){ const GLint& o=getUniformLocation(l);if(o==-1)return;glUniformMatrix2iv(o,1,0,glm::value_ptr(m)); }
        //inline void sendUniformMatrix2ivSafe(const char* l,std::vector<glm::imat2>& m, uint count){ const GLint& o=getUniformLocation(l);if(o==-1)return;std::vector<int> d;for(auto ma:m){int* m = glm::value_ptr(ma);for(uint i = 0; i < 4; i++){d.push_back(m[i]);}}glUniformMatrix2iv(o,count,0,&d[0]); } 
	...
	//Matrix 3x3
        ...
        //inline void sendUniformMatrix3(const char* l,glm::imat3& m){ glUniformMatrix3iv(getUniformLocationUnsafe(l),1,0,glm::value_ptr(m)); }
        //inline void sendUniformMatrix3v(const char* l,std::vector<glm::imat3>& m,uint count){ std::vector<int> d;for(auto ma:m){int* m = glm::value_ptr(ma);for(uint i = 0; i < 9; i++){d.push_back(m[i]);}}glUniformMatrix3iv(getUniformLocationUnsafe(l),count,0,&d[0]); }
        ...
        //inline void sendUniformMatrix3i(const char* l,glm::imat3& m){ glUniformMatrix3iv(getUniformLocationUnsafe(l),1,0,glm::value_ptr(m)); }
        //inline void sendUniformMatrix3iv(const char* l,std::vector<glm::imat3>& m,uint count){ std::vector<int> d;for(auto ma:m){int* m = glm::value_ptr(ma);for(uint i = 0; i < 9; i++){d.push_back(m[i]);}}glUniformMatrix3iv(getUniformLocationUnsafe(l),count,0,&d[0]); }  
        ...
        //inline void sendUniformMatrix3iSafe(const char* l,glm::imat3& m){ const GLint& o=getUniformLocation(l);if(o==-1)return;glUniformMatrix3iv(o,1,0,glm::value_ptr(m)); }
        //inline void sendUniformMatrix3ivSafe(const char* l,std::vector<glm::imat3>& m, uint count){ const GLint& o=getUniformLocation(l);if(o==-1)return;std::vector<int> d;for(auto ma:m){int* m = glm::value_ptr(ma);for(uint i = 0; i < 9; i++){d.push_back(m[i]);}}glUniformMatrix3iv(o,count,0,&d[0]); } 
	...
	//Matrix4x4
        ...
        //inline void sendUniformMatrix4(const char* l,glm::imat4& m){ glUniformMatrix4iv(getUniformLocationUnsafe(l),1,0,glm::value_ptr(m)); }
        //inline void sendUniformMatrix4v(const char* l,std::vector<glm::imat4>& m,uint count){ std::vector<int> d;for(auto ma:m){int* m = glm::value_ptr(ma);for(uint i = 0; i < 16; i++){d.push_back(m[i]);}}glUniformMatrix4iv(getUniformLocationUnsafe(l),count,0,&d[0]); }
        ...
        //inline void sendUniformMatrix4i(const char* l,glm::imat4& m){ glUniformMatrix4iv(getUniformLocationUnsafe(l),1,0,glm::value_ptr(m)); }
        //inline void sendUniformMatrix4iv(const char* l,std::vector<glm::imat4>& m,uint count){ std::vector<int> d;for(auto ma:m){int* m = glm::value_ptr(ma);for(uint i = 0; i < 16; i++){d.push_back(m[i]);}}glUniformMatrix4iv(getUniformLocationUnsafe(l),count,0,&d[0]); }  
        ...
        //inline void sendUniformMatrix4iSafe(const char* l,glm::imat4& m){ const GLint& o=getUniformLocation(l);if(o==-1)return;glUniformMatrix4iv(o,1,0,glm::value_ptr(m)); }
        //inline void sendUniformMatrix4ivSafe(const char* l,std::vector<glm::imat4>& m, uint count){ const GLint& o=getUniformLocation(l);if(o==-1)return;std::vector<int> d;for(auto ma:m){int* m = glm::value_ptr(ma);for(uint i = 0; i < 16; i++){d.push_back(m[i]);}}glUniformMatrix4iv(o,count,0,&d[0]); } 
