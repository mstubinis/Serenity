...
class Mesh::impl final{
    public:
        ...
        void _loadInternal(Mesh& mesh,epriv::MeshImportedData& data,string& file){
        ...
        void _processNode(const Mesh& mesh,epriv::MeshImportedData& data, const aiScene& scene,const aiNode& node, const aiNode& root, unordered_map<string, epriv::BoneNode*>& _map){
