...
Shaders::Detail::ShadersManagement::smaa_frag_2 = Shaders::Detail::ShadersManagement::version + Shaders::Detail::ShadersManagement::smaa_common +
    ...
    "    return (texture2DLod(searchTex, coord, 0.0)).r;\n"
    "}\n"
    ...
    "        c.y  = texture2DLod(edgesTex, coords.xy + vec2( 0.0, API_V_DIR(-1.0)), 0.0).r;\n"
    ...
    "    factor.x -= rounding.x * texture2DLod(edgesTex, texcoord.xy + vec2(0.0,  API_V_DIR(1.0)), 0.0).r;\n"
    "    factor.x -= rounding.y * texture2DLod(edgesTex, texcoord.zw + vec2(1.0,  API_V_DIR(1.0)), 0.0).r;\n"
    "    factor.y -= rounding.x * texture2DLod(edgesTex, texcoord.xy + vec2(0.0, API_V_DIR(-2.0)), 0.0).r;\n"
    "    factor.y -= rounding.y * texture2DLod(edgesTex, texcoord.zw + vec2(1.0, API_V_DIR(-2.0)), 0.0).r;\n"
    ...
    "    factor.x -= rounding.y * texture2DLod(edgesTex, texcoord.zw + vec2( 1.0, API_V_DIR(1.0)), 0.0).g;\n"
    "    factor.y -= rounding.x * texture2DLod(edgesTex, texcoord.xy + vec2(-2.0, 0.0), 0.0).g;\n"
    "    factor.y -= rounding.y * texture2DLod(edgesTex, texcoord.zw + vec2(-2.0, API_V_DIR(1.0)), 0.0).g;\n"
    "    weights *= saturate(factor);\n"
    "}\n"
    ...
    "        vec2 sqrt_d = sqrt(d);\n"
    "        float e2 = texture2DLod(edgesTex, coords.xz + vec2(0.0, API_V_DIR(1.0)), 0.0).g;\n"
