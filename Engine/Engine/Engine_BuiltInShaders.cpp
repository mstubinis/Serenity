...
Shaders::Detail::ShadersManagement::cubemap_prefilter_envmap_frag = Shaders::Detail::ShadersManagement::version + 
    ...
    "uniform float a;\n"
    "uniform int resSquared;\n"
    "uniform int NUM_SAMPLES;\n"
    "const float PI = 3.14159265;\n"
    "const float PI2 = 6.283185;\n"
    "const float PI4 = 12.56637;\n"
    ...
    "}\n"
    "vec3 ImportanceSampleGGX(vec2 Xi, vec3 Normal, vec3 Binormal, vec3 Tangent){\n"
    "    float phi = PI2 * Xi.x;\n"
    ...
    "    Half.z = cosTheta;\n"
    "\n"
    "    vec3 sampleVec = Tangent * Half.x + Binormal * Half.y + Normal * Half.z;\n"
    ...
    "    float saTexel  = PI4 / (6.0 * resSquared);\n"
    "    vec3 up = abs(N.z) < 0.999 ? vec3(0.0, 0.0, 1.0) : vec3(1.0, 0.0, 0.0);\n"
    "    vec3 tangent = normalize(cross(up, N));\n"
    "    vec3 bitangent = cross(N, tangent);\n"
    "    for(int i = 0; i < NUM_SAMPLES; ++i){\n"
    "        vec2 Xi = Hammersley(i, NUM_SAMPLES);\n"
    "        vec3 H = ImportanceSampleGGX(Xi, N,bitangent,tangent);\n"
