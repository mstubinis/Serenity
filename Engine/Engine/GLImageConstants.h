...
class ImageInternalFormat{
    public: enum Format{
        ...
        COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT,R3_G3_B2,RGB5_A1,RGB9_E5,RGB565,RGB8,RGBA8,RGB16,RGBA16,RGB16F,RGBA16F,RGB32F,RGBA32F,R8,RG8,RGBA4,RGB4,
        COMPRESSED_RED,COMPRESSED_RG,COMPRESSED_RGB,COMPRESSED_RGBA,COMPRESSED_SRGB,COMPRESSED_SRGB_ALPHA,DEPTH_COMPONENT,DEPTH_STENCIL,STENCIL_INDEX,
        RED,RG,RGB,RGBA,R8_SNORM,R16,R16_SNORM,RG8_SNORM,RG16,RG16_SNORM,RGB5,RGB8_SNORM,RGB10,RGB12,RGB16_SNORM,RGBA2,RGBA8_SNORM,RGBA12,R16F,R32F,
        RG32F,R8I,R8UI,R16I,R16UI,R32I,R32UI,RG8I,RG8UI,RG16I,RG16UI,RG32I,RG32UI,RGB8I,RGB8UI,RGB16I,RGB16UI,RGB32I,RGB32UI,RGBA8I,RGBA8UI,RGBA16I,
