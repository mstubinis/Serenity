...
class Mesh::impl{
    public:
        DefaultMeshBindFunctor DEFAULT_BIND_FUNCTOR;
        DefaultMeshUnbindFunctor DEFAULT_UNBIND_FUNCTOR;
        ...
        void _init(Mesh* super,string& name,btHeightfieldTerrainShape* heightfield,float threshold){
            m_File = "";
        ...
        void _init(Mesh* super,string& name,unordered_map<string,float>& grid,uint width,uint length,float threshold){
            m_File = "";
            m_threshold = threshold;
            m_SaveMeshData = false;
            m_Collision = nullptr;
        ...
        void _init(Mesh* super,string& name,float x, float y,float width, float height,float threshold){
            m_File = "";
            m_threshold = threshold;
            m_SaveMeshData = false;
            m_Collision = nullptr;
        ...
        void _init(Mesh* super,string& name,float width, float height,float threshold){
            m_File = "";
            m_threshold = threshold;
            m_SaveMeshData = false;
            m_Collision = nullptr;
        ...
        void _init(Mesh* super,string& name,string filename,CollisionType type,bool notMemory,float threshold){
            m_File = "";
            m_SaveMeshData = false;
            m_Collision = nullptr;
            m_Skeleton = nullptr;
        ...
        void _loadData(Mesh* super,ImportedMeshData& data,float threshold){
            ...
            Engine::Resources::MeshLoader::Detail::MeshLoadingManagement::_indexVBO(super,data,m_Indices,m_Vertices,m_threshold);
        }
        void _loadFromFile(string file,CollisionType type,float threshold){
        ...
        void _loadFromOBJMemory(string data,CollisionType type,float threshold){
            ImportedMeshData d;
...
const Mesh::float getRadius() const { return m_i->m_radius; }
